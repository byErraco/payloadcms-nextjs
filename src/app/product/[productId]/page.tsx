...
import ImageSlider from "@/components/products/ImagesSlider"
...
const Page = async ({ params }: PageProps) => {
  ...
  return (
    <MaxWidthWrapper className="">
      ...
      <ProductReel
        href="/products"
        query={{ category: categoriesLabels, limit: 4 }}
        // query={{ category: product.categories, limit: 4 }}
        title={`Similar ${categoriesLabels[0]}`}
        subtitle={`Browse similar high-quality ${categoriesLabels[0]} just like '${product.title}'`}
      />
    </MaxWidthWrapper>
  )
}
